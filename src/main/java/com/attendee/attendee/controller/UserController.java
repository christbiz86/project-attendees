...
public class UserController {
	...
	//nyoba
	@RequestMapping(value = "/user/pass/{pass}", method = RequestMethod.GET)
	public ResponseEntity<?> findPassword(@PathVariable String pass) throws ValidationException {
		try {
			User user = userService.findPassword(pass);
